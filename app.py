...
df = pd.read_csv("crime_2020-2024.csv")
...
selected_crime = st.sidebar.selectbox("Select Crime", crimes)
...
fig.update_layout(width=1400, height=680, margin=dict(l=0, r=90, t=0, b=10))
